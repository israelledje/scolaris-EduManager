...
urlpatterns = [
    ...
    path('bulletins/pdf-class/<int:class_id>/', views.bulletin_pdf_class, name='bulletin_pdf_class'),
    path('bulletins/approve-batch/', views.bulletin_approve_batch, name='bulletin_approve_batch'),
